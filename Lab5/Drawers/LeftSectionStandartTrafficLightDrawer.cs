...
{
    public class LeftSectionStandartTrafficLightDrawer : TrafficLightDrawerBase
    {
        ...
        protected override Point GetPosition(string lightName)
        {
            switch (lightName)
            {
                ...
                case LeftSectionStandartTrafficLightController.LeftGreenLightName:
        ...
        protected override char GetLightSymbol(string lightName)
        {
            if (lightName == LeftSectionStandartTrafficLightController.LeftGreenLightName)
            {
                return LeftArrow;
            }

            return base.GetLightSymbol(lightName);
        }
        ...
        private static void PrepareConsole(Point zoneOffset)
        {
            ...
            Console.WriteLine(DefaultLightSymbol);
            Console.SetCursorPosition(zoneOffset.Left - 1, zoneOffset.Top + 2);
